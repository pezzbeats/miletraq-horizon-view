...
export function MobileSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed top-0 left-0 h-full w-80 z-50 bg-card/95 backdrop-blur-md border-r border-border/50 shadow-xl transition-transform duration-300 lg:hidden overflow-y-auto custom-scrollbar",
